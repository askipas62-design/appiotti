...
import { BabyFootIcon, PingPongIcon, BillardIcon, TrampolineIcon, AccessoiresIcon, ConsolesIcon } from "../components/CategoryIcons";
...
export default function Home() {
  ...
  const categoryDefs = [
    ...
    { name: "Consoles", slug: "consoles", icon: <ConsolesIcon className="w-8 h-8" />, image: "/images/categories/consoles.jpg", gradient: "from-[#3B82F6] to-[#8B5CF6]" },
